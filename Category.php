...
?>
    ...
    <div class="container">
      <div class="row multi-columns-row">
          <?php
          $products= getLatest("*", "items","Item_ID",'12','1');
          foreach ($products as $product){
                echo'<div class="col-sm-6 col-md-3 col-lg-3">
                  <div class="shop-item">
                    <div class="shop-item-image"><img src="uploads/items/'.$product['Image'].'" alt="Accessories Pack"/>
                      <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>
                    </div>
                    <h4 class="shop-item-title font-alt"><a href="singleItem.php?itemId='.$product['Item_ID'].'">'.$product['Name'].'</a></h4>'.$product['Price'].'
                  </div>
                </div>';
            }
          ?>
